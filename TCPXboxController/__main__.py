...
parser.add_argument('-S', '--send_port', type=int, help='TCP port to send the signals to. Default=36363', default=36363)
parser.add_argument('-R', '--receive_port', type=int, help='TCP port to receive vibration commands. Default=36364', default=36364)
